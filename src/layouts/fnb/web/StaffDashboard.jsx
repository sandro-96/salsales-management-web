// create a new file src/layouts/fnb/web/StaffDashboard.jsx
import { Outlet, NavLink } from "react-router-dom";
import { FaHome, FaUsers, FaCog } from "react-icons/fa";
const FnbWebStaffDashboard = () => {
    return (
        <div className="min-h-screen flex flex-col md:flex-row">
            {/* Sidebar */}
            <aside className="w-full md:w-64 bg-red-700 text-white p-4">
                <h1 className="text-2xl font-bold mb-6">FNB Web Staff</h1>
...
export default FnbWebStaffDashboard;