                ...
                <div className="grid w-full max-w-sm grid-cols-1 gap-4">
                    ...
                    <form onSubmit={handleLogin} className="flex flex-col gap-6">
                            ...
                            <div className="flex items-center my-4">
                                ...
                                <span className="mx-5 text-sm font-medium text-gray-700">Or continue with</span>
                                <hr className="flex-grow border-t border-gray-300" />
                            </div>
                            <GoogleSignInButton callback={handleGoogleSignIn} text="signin_with" className="w-full" />
                        </form>
                </div>
            </div>
