...
const NotFoundPage = () => {
    return (
        <div className="h-screen flex flex-col items-center justify-center bg-gray-100 dark:bg-background px-4 text-center text-foreground">
            <h1 className="text-5xl font-bold text-gray-800 dark:text-foreground mb-4">404</h1>
            <p className="text-xl text-gray-600 dark:text-muted-foreground mb-6">Trang bạn yêu cầu không tồn tại.</p>
            <a
                href="/"
