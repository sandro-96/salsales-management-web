...
export function BranchListStatCards({
  stats,
  activeFilter,
  loading,
  onFilterChange,
  ...
  const cards = [
    {
      key: "ALL",
      label: t("pages.branches.list.filterAll"),
      shortLabel: t("pages.branches.list.filterAllShort"),
      hint: t("pages.branches.list.statAllHint"),
      value: stats.total,
    },
    {
      key: "ACTIVE",
      label: t("pages.branches.list.statActive"),
      shortLabel: t("pages.branches.list.statActiveShort"),
      hint: t("pages.branches.list.statActiveHint"),
      value: stats.active,
    },
    {
      key: "INACTIVE",
      label: t("pages.branches.list.statInactive"),
      shortLabel: t("pages.branches.list.statInactiveShort"),
      hint: t("pages.branches.list.statInactiveHint"),
      value: stats.inactive,
    },
    {
      key: "DEFAULT",
      label: t("pages.branches.list.statDefault"),
      shortLabel: t("pages.branches.list.statDefaultShort"),
      hint: t("pages.branches.list.statDefaultHint"),
