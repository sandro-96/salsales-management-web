...
export function CustomerListStatCards({
  stats,
  activeFilter,
  loading,
  onFilterChange,
  ...
  const cards = [
    {
      key: "ALL",
      label: t("pages.customers.list.filterAll"),
      shortLabel: t("pages.customers.list.filterAllShort"),
      hint: t("pages.customers.list.statAllHint"),
      value: stats.total,
    },
    {
      key: "WITH_PHONE",
      label: t("pages.customers.list.statWithPhone"),
      shortLabel: t("pages.customers.list.statWithPhoneShort"),
      hint: t("pages.customers.list.statWithPhoneHint"),
      value: stats.withPhone,
    },
    {
      key: "WITH_EMAIL",
      label: t("pages.customers.list.statWithEmail"),
      shortLabel: t("pages.customers.list.statWithEmailShort"),
      hint: t("pages.customers.list.statWithEmailHint"),
      value: stats.withEmail,
    },
    {
      key: "LOYALTY",
      label: t("pages.customers.list.statLoyalty"),
      shortLabel: t("pages.customers.list.statLoyaltyShort"),
      hint: t("pages.customers.list.statLoyaltyHint"),
      value: stats.loyalty,
    },
  ];
